    ...
    <div className="px-6 md:px-20 py-12">
      ...
      <section className='mx-20'>
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {/* Card 1 */}
            <div className="bg-white shadow-lg p-10 rounded-lg text-gray-700 hover:scale-105 hover:-translate-y-2 transition-transform duration-300 ease-in-out hover:bg-gray-200 flex flex-col items-center">
        ...
        {/* Card 2 */}
            <div className="bg-white shadow-lg p-10 rounded-lg text-gray-700 hover:scale-105 hover:-translate-y-2 transition-transform duration-300 hover:bg-gray-200 flex flex-col items-center">
